<div class="container-fluid">
  ...
  <!-- DataTales Example -->
      ...
      <div class="card-body">
          ...
          <input type="hidden" class="form-control form-control-sm" id="id_proyek" name="id_proyek" readonly value="<?= $id_proyek ?>">
            <div class="col-md-9">
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <div class="row">
                      <div class="col-sm-4">
                        <input type="text" class="form-control form-control-sm" id="id_jalan" name="id_jalan" readonly value="<?= set_value('id_jalan'); ?>">
                      </div>
                      <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="nama_jalan" name="nama_jalan" readonly value="<?= set_value('nama_jalan'); ?>">
                      </div>
                    </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input class="form-control" type="date"  id="tanggal_kontrak" name="tanggal_kontrak" value="<?= set_value('tanggal_kontrak'); ?>" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input class="form-control" type="date"  id="akhir_kontrak" name="akhir_kontrak" value="<?= set_value('akhir_kontrak'); ?>" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input class="form-control" type="date"  id="pelaksanaan" name="pelaksanaan" value="<?= set_value('pelaksanaan'); ?>" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" class="form-control form-control-sm" id="sumber_dana" name="sumber_dana"  value="<?= set_value('sumber_dana'); ?>" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <div class="row">
                    ...
                    <div class="col-md-11">
                      <input type="text" class="form-control form-control-sm" id="anggaran" name="anggaran"  value="<?= set_value('anggaran'); ?>" required>
                    </div>
                  </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="number" class="form-control form-control-sm" max="2090" min="2020" id="tahun_anggaran" name="tahun_anggaran" value="<?= set_value('tahun_anggaran'); ?>" required>
              ...
              <div class="form-group row">
                <div class="col-md-3">
                  <input type="text" readonly class="form-control-plaintext" id="progres" name="progres[]" value="Progres 0%">
                </div>
                <div class="col-md-9">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="image" name="image[]" required multiple="multiple">
            ...
            <div class="form-group row">
              <div class="col-md-3">
                <input type="text" readonly class="form-control-plaintext" id="progres" name="progres[]" value="Progres 50%">
              </div>
              <div class="col-md-9">
                  <div class="custom-file">
          ...
          <div class="form-group row">
            <div class="col-md-3">
              <input type="text" readonly class="form-control-plaintext" id="progres" name="progres[]" value="Progres 100%">
            </div>
            <div class="col-md-9">
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="image" name="image[]"  multiple="multiple">
